...
if __name__ == "__main__":
   ...
   # 处理数据
    df = smart_column_processor(
        r'Data\split_datasets\One_Hot_dataset\pridict_city\splitdataset\pridict_port\all_updated_with_Stime.csv',
        config
    )
      # 创建保存路径
    save_dir = Path("Data\split_datasets\One_Hot_dataset\pridict_city\splitdataset\pridict_port\pridict_Stime")
