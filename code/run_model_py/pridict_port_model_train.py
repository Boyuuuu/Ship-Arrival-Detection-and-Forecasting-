...
CONFIG = {
    "data_folder": r"Data/split_datasets/One_Hot_dataset2",
    "model_save_path": r"Result\Predict_city2\best_model.pth",
    "preprocessor_path": r"Result\Predict_city2\preprocessor.joblib",
    "batch_size": 2048,
    "max_epochs": 800,
    "patience": 20,
    "metrics_plot_path": r"Result\Predict_city2\training_metrics.png",
    "confusion_matrix_path": r"Result\Predict_city2\confusion_matrix.png",
    "prf_curve_path": r"Result\Predict_city2\prf_curves.png"  # 新增PRF曲线路径
}
